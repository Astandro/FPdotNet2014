...
namespace PAWNProject
{
    public partial class TipsMainPage : PhoneApplicationPage
    {
        ...
        public TipsMainPage()
        {
            ...
            listTips.Add("Dalam mengerjakan soal demi soal psikotes yang kita hadapi, konsentrasi, ketelitian dan ketenangan diri adalah bagian penting dalam strategi memudahkan kita mengerjakan tes semacam ini. Karena tanpa ketiganya maka hasil yang diharapkan akan jauh dari kenyataan. Bisa saja kita pandai dan cerdas akan tetapi tanpa ketelitian serta ketenangan diri maka hal ini akan dirasakan sebagai kekurangan.");
